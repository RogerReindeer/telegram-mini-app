import { z } from 'zod';
const originIds = ['blacksmith_family', 'herbalist_family', 'hunter_family', 'merchant_family'];
const visualThemes = ['rain', 'festival', 'night', 'work', 'tea', 'rooftops', 'home', 'grove', 'forge', 'herbs', 'outskirts', 'market', 'sickroom'];
const guidedSlots = [
